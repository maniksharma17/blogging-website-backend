...
// .wrangler/tmp/bundle-sVuyFH/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/maniksharma/Documents/100xdev/Blogging app/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// .wrangler/tmp/bundle-sVuyFH/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-sVuyFH/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  const prisma = new import_edge.PrismaClient({
    datasourceUrl: "prisma://accelerate.prisma-data.net/?api_key=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlfa2V5IjoiYTdlMTBjOWYtYzU3Yi00YWJhLThiYzYtOWY1ZmFlYzFhZWU5IiwidGVuYW50X2lkIjoiNGVhYTk3OTVlMzE2NDlhZDk1MjRmNDZjNTdmZmNkMDY3ZmUzNmJmMjdiNmJhMzYzODcxZTY2MjE0Y2IyZWFjZSIsImludGVybmFsX3NlY3JldCI6IjkxZTU2YWZkLTNlZGItNDFkNS04NGZlLTFhMTYzMzFmNmE5NiJ9.C_uRd6WGLC-HV05Pam0gGmf7VICU0yJt3uubAPBbWH4"
...
init_checked_fetch();
init_modules_watch_stub();
async function userMiddleware(c, next) {
  const header = c.req.header("Authentication");
  const token = header.split(" ")[1];
  try {
    const tokenVerification = await verify2(token, c.env.JWT_SECRET);
    if (tokenVerification) {
      c.status(200);
      c.set("id", tokenVerification.id);
      await next();
    }
  } catch (e) {
    c.status(403);
